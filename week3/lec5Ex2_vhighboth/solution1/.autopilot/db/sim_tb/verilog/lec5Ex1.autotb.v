...
`define AUTOTB_DUT      lec5Ex1
`define AUTOTB_DUT_INST AESL_inst_lec5Ex1
`define AUTOTB_TOP      apatb_lec5Ex1_top
`define AUTOTB_LAT_RESULT_FILE "lec5Ex1.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "lec5Ex1.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_lec5Ex1_top
...
`define AUTOTB_TVIN_c  "./c.lec5Ex1.autotvin_c.dat"
`define AUTOTB_TVIN_x  "./c.lec5Ex1.autotvin_x.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.lec5Ex1.autotvin_c.dat"
`define AUTOTB_TVIN_x_out_wrapc  "./rtl.lec5Ex1.autotvin_x.dat"
`define AUTOTB_TVOUT_y  "./c.lec5Ex1.autotvout_y.dat"
`define AUTOTB_TVOUT_y_out_wrapc  "./impl_rtl.lec5Ex1.autotvout_y.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 6001;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 67;
parameter LENGTH_y = 1;
parameter LENGTH_c = 22;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.lec5Ex1.autotvout_y.dat", "r");
    fp2 = $fopen("./impl_rtl.lec5Ex1.autotvout_y.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.lec5Ex1.autotvout_y.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.lec5Ex1.autotvout_y.dat\"!");
    else begin
        $display("Comparing rtl.lec5Ex1.autotvout_y.dat with impl_rtl.lec5Ex1.autotvout_y.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
