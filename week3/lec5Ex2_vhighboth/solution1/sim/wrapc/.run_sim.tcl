...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lec5Ex1.autotvin.dat"
	set constFileTvOut       "lec5Ex1.autotvout.dat"
	set constFileHdlTvIn     "lec5Ex1.autohdltvin.dat"
	set constFileHdlTvOut    "lec5Ex1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
