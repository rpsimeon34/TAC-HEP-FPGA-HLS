...
// ==============================================================
#ifndef __lec6Ex2a_mac_muladEe__HH__
#define __lec6Ex2a_mac_muladEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(lec6Ex2a_mac_muladEe) {
    ...
    SC_CTOR(lec6Ex2a_mac_muladEe):  simcore_mac_0_U ("simcore_mac_0_U") {
