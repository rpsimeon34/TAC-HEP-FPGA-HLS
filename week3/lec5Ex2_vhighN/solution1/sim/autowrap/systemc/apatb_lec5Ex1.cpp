...
// tvout file define: "y"
#define AUTOTB_TVOUT_PC_y  "../tv/rtldatafile/rtl.lec5Ex1.autotvout_y.dat"
...
extern "C" void lec5Ex1 (
int* y,
int c[22],
int x);

extern "C" void AESL_WRAP_lec5Ex1 (
int* y,
int c[22],
int x)
{
	...
	else
	{
		...
		sc_bv<32>* c_tvin_wrapc_buffer = new sc_bv<32>[22];
		...
		tcl_file.set_num(22, &tcl_file.c_depth);
