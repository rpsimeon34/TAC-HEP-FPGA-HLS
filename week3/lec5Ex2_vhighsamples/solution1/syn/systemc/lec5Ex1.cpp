...
const sc_lv<5> lec5Ex1::ap_const_lv5_A = "1010";
const sc_lv<1> lec5Ex1::ap_const_lv1_1 = "1";
const sc_lv<4> lec5Ex1::ap_const_lv4_0 = "0000";
const sc_lv<5> lec5Ex1::ap_const_lv5_1F = "11111";
const sc_lv<32> lec5Ex1::ap_const_lv32_4 = "100";
...
void lec5Ex1::thread_arr_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        arr_address0 =  (sc_lv<4>) (zext_ln20_1_fu_155_p1.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_136_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln16_fu_144_p2.read(), ap_const_lv1_1))) {
        ...
        arr_address0 =  (sc_lv<4>) (zext_ln20_fu_150_p1.read());
    } else {
        arr_address0 = "XXXX";
    }
}
...
void lec5Ex1::thread_c_address0() {
    c_address0 =  (sc_lv<4>) (zext_ln23_fu_159_p1.read());
}
...
void lec5Ex1::thread_icmp_ln16_fu_144_p2() {
    icmp_ln16_fu_144_p2 = (!i_0_reg_104.read().is_01() || !ap_const_lv5_0.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_104.read() == ap_const_lv5_0);
}
...
void lec5Ex1::thread_sext_ln15_fu_132_p1() {
    sext_ln15_fu_132_p1 = esl_sext<32,5>(i_0_reg_104.read());
}
...
void lec5Ex1::thread_zext_ln20_fu_150_p1() {
    zext_ln20_fu_150_p1 = esl_zext<64,5>(grp_fu_125_p2.read());
}
