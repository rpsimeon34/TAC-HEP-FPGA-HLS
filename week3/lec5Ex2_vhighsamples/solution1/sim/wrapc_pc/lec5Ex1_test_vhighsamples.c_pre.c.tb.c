...
// ==============================================================
# 1 "/afs/hep.wisc.edu/user/rsimeon/tac_hep_fpga/TAC-HEP-FPGA-HLS/week3/lec5Ex1_test_vhighsamples.c"
# 1 "/afs/hep.wisc.edu/user/rsimeon/tac_hep_fpga/TAC-HEP-FPGA-HLS/week3/lec5Ex1_test_vhighsamples.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/afs/hep.wisc.edu/user/rsimeon/tac_hep_fpga/TAC-HEP-FPGA-HLS/week3/lec5Ex1_test_vhighsamples.c" 2
...
# 2 "/afs/hep.wisc.edu/user/rsimeon/tac_hep_fpga/TAC-HEP-FPGA-HLS/week3/lec5Ex1_test_vhighsamples.c" 2
...
# 3 "/afs/hep.wisc.edu/user/rsimeon/tac_hep_fpga/TAC-HEP-FPGA-HLS/week3/lec5Ex1_test_vhighsamples.c" 2
...
#endif
# 5 "/afs/hep.wisc.edu/user/rsimeon/tac_hep_fpga/TAC-HEP-FPGA-HLS/week3/lec5Ex1_test_vhighsamples.c"
int main () {
  const int samples=6000;
  FILE *oFile;

  int inp, output;
  int coef[11] = {0,-10,-9,23,56,63,56,23,-9,-10,0,};
...
#endif
# 24 "/afs/hep.wisc.edu/user/rsimeon/tac_hep_fpga/TAC-HEP-FPGA-HLS/week3/lec5Ex1_test_vhighsamples.c"
...
# 24 "/afs/hep.wisc.edu/user/rsimeon/tac_hep_fpga/TAC-HEP-FPGA-HLS/week3/lec5Ex1_test_vhighsamples.c"
  ...
  if (system("diff -w lec5Ex1_out.dat lec5Ex1_out_ref_vhighsamples.dat")) {
...
#endif
# 49 "/afs/hep.wisc.edu/user/rsimeon/tac_hep_fpga/TAC-HEP-FPGA-HLS/week3/lec5Ex1_test_vhighsamples.c"
