...
$(ObjDir)/lec5Ex1_test_vhighsamples.c_pre.c.tb.o : lec5Ex1_test_vhighsamples.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lec5Ex1_test_vhighsamples.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/lec5Ex1.c_pre.c.tb.o : lec5Ex1.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lec5Ex1.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
