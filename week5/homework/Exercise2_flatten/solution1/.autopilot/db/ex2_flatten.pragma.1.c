...
# 5 "./ex2.h" 2
# 1 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/ap_cint.h" 1
# 83 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/ap_cint.h"
# 1 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_apint.h" 1
# 57 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_apint.h"
# 1 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 1
# 97 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.h"
# 1 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.def" 1
...
# 98 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 1 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt_ext.def" 1
...
# 99 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 108 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.h"
# 1 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.def" 1
...
# 109 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 1 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt_ext.def" 1
...
# 110 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.h" 2
# 131 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_dt.h"
typedef int __attribute__ ((bitwidth(64))) int64;
typedef unsigned int __attribute__ ((bitwidth(64))) uint64;
# 58 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_apint.h" 2
# 1 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_ssdm_bits.h" 1
# 59 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/etc/autopilot_apint.h" 2
# 84 "/opt/Xilinx/Vivado/2020.1/common/technology/autopilot/ap_cint.h" 2
# 6 "./ex2.h" 2
...
void ex2(din_t A[6][6], din_t B[6], dout_t C[6]);
# 2 "ex2_flatten.c" 2

void ex2(din_t A[6][6], din_t B[6], dout_t C[6]) {_ssdm_SpecArrayDimSize(A, 6);_ssdm_SpecArrayDimSize(B, 6);_ssdm_SpecArrayDimSize(C, 6);
  int i,j;
  dint_t acc;

acc = 0;
LOOP_I:for(i=0; i < 6; i++){
    LOOP_J: for(j=0; j < 6; j++){
