...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("B_q0", 5, hls_in, 1, "ap_memory", "mem_dout", 1),
	Port_Property("C_address0", 3, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("C_ce0", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("C_we0", 1, hls_out, 2, "ap_memory", "mem_we", 1),
	Port_Property("C_d0", 6, hls_out, 2, "ap_memory", "mem_din", 1),
};
const char* HLS_Design_Meta::dut_name = "ex2";
