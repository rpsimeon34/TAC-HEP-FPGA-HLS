...
// ==============================================================
#ifndef __ex3_sdiv_32s_32nsbkb__HH__
#define __ex3_sdiv_32s_32nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ex3_sdiv_32s_32nsbkb) {
    ...
    SC_CTOR(ex3_sdiv_32s_32nsbkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
