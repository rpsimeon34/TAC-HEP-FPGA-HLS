...
// ==============================================================
#ifndef __ex3_mac_muladd_6scud__HH__
#define __ex3_mac_muladd_6scud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ex3_mac_muladd_6scud) {
    ...
    SC_CTOR(ex3_mac_muladd_6scud):  simcore_mac_0_U ("simcore_mac_0_U") {
