...
// ==============================================================
#ifndef __ex3_sdiv_6s_6ns_6bkb__HH__
#define __ex3_sdiv_6s_6ns_6bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ex3_sdiv_6s_6ns_6bkb) {
    ...
    ACMP_sdiv_seq<ID, 10, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(ex3_sdiv_6s_6ns_6bkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
