...
// ==============================================================
#ifndef __ex2_mac_muladd_5sbkb__HH__
#define __ex2_mac_muladd_5sbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ex2_mac_muladd_5sbkb) {
    ...
    SC_CTOR(ex2_mac_muladd_5sbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
