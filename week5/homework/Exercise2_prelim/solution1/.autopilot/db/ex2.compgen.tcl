...
set out_width 12
set exp i0*i1+i2
set arg_lists {i0 {5 1 +} i1 {5 1 +} m {10 1 +} i2 {12 0 +} p {12 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A \
    op interface \
    ports { A_address0 { O 6 vector } A_ce0 { O 1 bit } A_q0 { I 5 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B \
    op interface \
    ports { B_address0 { O 3 vector } B_ce0 { O 1 bit } B_q0 { I 5 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C \
    op interface \
    ports { C_address0 { O 3 vector } C_ce0 { O 1 bit } C_we0 { O 1 bit } C_d0 { O 6 vector } } \
} "
} else {
