# 1 "arrpartblock_lec8Ex1.c"
# 1 "arrpartblock_lec8Ex1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
_ssdm_SpecArrayPartition( in, 1, "BLOCK", 2, "");
_ssdm_SpecArrayPartition( out, 1, "BLOCK", 3, "");
