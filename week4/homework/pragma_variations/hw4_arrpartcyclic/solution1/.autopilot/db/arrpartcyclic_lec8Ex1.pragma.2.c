# 1 "arrpartcyclic_lec8Ex1.c"
# 1 "arrpartcyclic_lec8Ex1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
void lec8Ex1 (
  ...
  unsigned int c,
  unsigned int out[60]
  ) {_ssdm_SpecArrayDimSize(in, 60);_ssdm_SpecArrayDimSize(out, 60);

_ssdm_SpecArrayPartition( in, 1, "CYCLIC", 2, "");
_ssdm_SpecArrayPartition( out, 1, "CYCLIC", 3, "");

 unsigned int x, y;
   unsigned int tmp1, tmp2, tmp3;

for_Loop: for (unsigned int i=0 ; i < 60; i++) {
