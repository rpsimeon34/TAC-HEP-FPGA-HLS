...
set C_modelArgList {
	{ in_A int 32 regular {array 6 { 1 3 } 1 1 }  }
	{ in_B int 32 regular {array 6 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "in_A", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in_A","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 5,"step" : 1}]}]}]} , 
 	{ "Name" : "in_B", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in_B","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 5,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ in_B_address0 sc_out sc_lv 3 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_B_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "in_B", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	in_B { ap_memory {  { in_B_address0 mem_address 1 3 }  { in_B_ce0 mem_ce 1 1 }  { in_B_q0 mem_dout 0 32 } } }
